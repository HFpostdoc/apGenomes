...
# Output
my_output <- paste("../results","hymen_apg_busco.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
# Legend
my_title <- "BUSCO Assessment Results (Hymenoptera Lineage)"
...
my_species <- c('A. picea', 'A. picea', 'A. picea', 'A. picea', 'A. fulva', 'A. fulva', 'A. fulva', 'A. fulva', 'A. ashmeadi', 'A. ashmeadi', 'A. ashmeadi', 'A. ashmeadi', 'A. floridensis', 'A. floridensis', 'A. floridensis', 'A. floridensis', 'A. rudis 2', 'A. rudis 2', 'A. rudis 2', 'A. rudis 2', 'A. miamiana', 'A. miamiana', 'A. miamiana', 'A. miamiana', 'A. rudis 1', 'A. rudis 1', 'A. rudis 1', 'A. rudis 1')
...
my_percentage <- c(96.4, 0.3, 2.2, 1.1, 95.7, 0.4, 2.4, 1.5, 96.7, 0.5, 1.8, 1.0, 97.3, 0.3, 1.6, 0.8, 96.6, 0.2, 2.4, 0.8, 96.9, 0.4, 2.0, 0.7, 96.4, 0.5, 2.1, 1.0)
my_values <- c(4256, 15, 99, 45, 4226, 17, 107, 65, 4270, 23, 81, 41, 4295, 15, 70, 35, 4264, 8, 107, 36, 4279, 17, 87, 32, 4257, 20, 94, 44)
