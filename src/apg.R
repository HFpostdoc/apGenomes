...
gs.size <- readLines("../data/storage/apg/genscope/gs_summary.txt")
...
## Creating the BUSCO plot
busco.key <- read.csv("../data/storage/apg/ncbi_data/key_busco_spp.txt", 
                      header = FALSE)
busco.key <- rbind(busco.key, cbind(rownames(apg.size), apg.size[, 1]))
...
######################################
# Output
my_output <- paste("../results","busco_hymen_all.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
# Colors
...
my_species <- c('SM-OOBI', 'SM-OOBI', 'SM-OOBI', 'SM-OOBI', 'SM-TRCO', 'SM-TRCO', 'SM-TRCO', 'SM-TRCO', 'SM-POBA', 'SM-POBA', 'SM-POBA', 'SM-POBA', 'SM-LANI', 'SM-LANI', 'SM-LANI', 'SM-LANI', 'SM-TRSE', 'SM-TRSE', 'SM-TRSE', 'SM-TRSE', 'SM-AZXXN', 'SM-AZXXN', 'SM-AZXXN', 'SM-AZXXN', 'SM-AZXXP', 'SM-AZXXP', 'SM-AZXXP', 'SM-AZXXP', 'SM-TRZE', 'SM-TRZE', 'SM-TRZE', 'SM-TRZE', 'SM-CAFL', 'SM-CAFL', 'SM-CAFL', 'SM-CAFL', 'SM-AZXXQ', 'SM-AZXXQ', 'SM-AZXXQ', 'SM-AZXXQ', 'SM-CYCO', 'SM-CYCO', 'SM-CYCO', 'SM-CYCO', 'SM-MOPH', 'SM-MOPH', 'SM-MOPH', 'SM-MOPH', 'SM-FOEX', 'SM-FOEX', 'SM-FOEX', 'SM-FOEX', 'SM-LIHU', 'SM-LIHU', 'SM-LIHU', 'SM-LIHU', 'SM-AZXXR', 'SM-AZXXR', 'SM-AZXXR', 'SM-AZXXR', 'SM-PSGR', 'SM-PSGR', 'SM-PSGR', 'SM-PSGR', 'SM-TECU', 'SM-TECU', 'SM-TECU', 'SM-TECU', 'SM-AZXXM', 'SM-AZXXM', 'SM-AZXXM', 'SM-AZXXM', 'SM-WAAU', 'SM-WAAU', 'SM-WAAU', 'SM-WAAU', 'SM-VOEM', 'SM-VOEM', 'SM-VOEM', 'SM-VOEM', 'SM-ATCE', 'SM-ATCE', 'SM-ATCE', 'SM-ATCE', 'SM-HASA', 'SM-HASA', 'SM-HASA', 'SM-HASA', 'SM-SOIN', 'SM-SOIN', 'SM-SOIN', 'SM-SOIN', 'SM-AZXXO', 'SM-AZXXO', 'SM-AZXXO', 'SM-AZXXO', 'SM-ACEC', 'SM-ACEC', 'SM-ACEC', 'SM-ACEC', 'SM-DIQU', 'SM-DIQU', 'SM-DIQU', 'SM-DIQU', 'SM-AJDMW', 'SM-AJDMW', 'SM-AJDMW', 'SM-AJDMW', 'SM-ATCO', 'SM-ATCO', 'SM-ATCO', 'SM-ATCO')
my_species <- busco.key[match(my_species, busco.key[, 1]), 2]
...
my_percentage <- c(97.2, 0.4, 1.1, 1.3, 97.2, 0.3, 1.9, 0.6, 94.2, 0.1, 4.6, 1.1, 87.5, 0.7, 8.8, 3.0, 97.4, 0.3, 1.6, 0.7, 96.4, 0.3, 2.2, 1.1, 95.7, 0.4, 2.4, 1.5, 97.2, 0.2, 2.0, 0.6, 98.1, 0.4, 1.1, 0.4, 96.7, 0.5, 1.8, 1.0, 96.9, 0.7, 1.7, 0.7, 95.9, 0.1, 2.9, 1.1, 94.1, 2.2, 2.8, 0.9, 97.2, 0.3, 1.9, 0.6, 97.3, 0.3, 1.6, 0.8, 95.6, 0.3, 2.7, 1.4, 87.5, 5.9, 3.5, 3.1, 96.6, 0.2, 2.4, 0.8, 97.3, 0.2, 1.8, 0.7, 97.8, 0.3, 1.4, 0.5, 94.5, 0.1, 4.0, 1.4, 97.3, 0.4, 1.4, 0.9, 95.9, 0.4, 2.4, 1.3, 96.9, 0.4, 2.0, 0.7, 96.6, 0.3, 2.4, 0.7, 95.1, 0.3, 2.9, 1.7, 96.4, 0.5, 2.1, 1.0, 97.6, 0.2, 1.6, 0.6)
my_values <- c(4292, 18, 50, 55, 4291, 13, 86, 25, 4158, 4, 202, 51, 3862, 29, 388, 136, 4302, 15, 72, 26, 4256, 15, 99, 45, 4226, 17, 107, 65, 4292, 7, 90, 26, 4332, 18, 47, 18, 4270, 23, 81, 41, 4278, 29, 76, 32, 4234, 5, 128, 48, 4153, 97, 122, 43, 4293, 12, 83, 27, 4295, 15, 70, 35, 4219, 13, 120, 63, 3861, 259, 156, 139, 4264, 8, 107, 36, 4296, 8, 78, 33, 4317, 12, 64, 22, 4171, 6, 178, 60, 4294, 17, 63, 41, 4235, 16, 106, 58, 4279, 17, 87, 32, 4265, 15, 106, 29, 4200, 13, 129, 73, 4257, 20, 94, 44, 4311, 8, 71, 25)
######################################
...
busco.hymen <- read.table("../data/storage/apg/busco/busco_hymen_brief_ncbi.txt")
busco.hymen <- busco.hymen[!(grepl("SOFU", busco.hymen[, 1])), ]
busco.hymen.apg <- read.table("../data/storage/apg/busco/busco_hymen_brief_apg.txt")
busco.hymen <- rbind(busco.hymen, busco.hymen.apg)
busco.hymen[, 1] <- do.call(rbind, strsplit(as.character(busco.hymen[, 1]), "summary_"))[, 2]
busco.hymen[, 1] <- gsub(".txt:", "", busco.hymen[, 1])
...
busco.hymen.noapg <- as.numeric(busco.hymen[!(grepl("SM-AZ", busco.hymen[, 1]) | 
                                 grepl("SM-AJ", busco.hymen[, 1]) | 
                                              grepl("apg", busco.hymen[, 1])), 3])
