...
# Output
my_output <- paste("../results","insect_apg_busco.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_percentage <- c(97.9, 0.5, 1.1, 0.5, 97.6, 0.5, 1.1, 0.8, 98.1, 0.9, 0.7, 0.3, 98.6, 0.4, 0.7, 0.3, 98.3, 0.6, 0.6, 0.5, 98.3, 0.6, 0.5, 0.6, 98.1, 0.7, 0.8, 0.4)
my_values <- c(1624, 8, 18, 8, 1618, 8, 18, 14, 1626, 15, 12, 5, 1635, 7, 12, 4, 1630, 10, 10, 8, 1630, 10, 9, 9, 1626, 11, 13, 8)
